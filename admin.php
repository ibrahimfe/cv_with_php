...
<body>
  <!-- <div class="container mt-5"> -->
    <nav class="navbar">
      <div class="nav-con">
        <h1>Update CV</h1>
        <a class="button" href="/cv_ibrahim">View</a>
      </div>
    </nav>
    <div class="container">
      <form method="post">
        <div class="form">
              ...
              <textarea class="form-control-text" id="pendidikan" name="pendidikan" rows="3" placeholder="Pendidikan" required><?php echo $data['pendidikan']; ?></textarea>
              <label for="pengalamanKerja" class="form-label">Pengalaman Kerja</label>
              <textarea class="form-control-text" id="pengalamanKerja" name="pengalaman_kerja" rows="3" placeholder="Pengalaman Kerja" required><?php echo $data['pengalaman_kerja']; ?></textarea>
              <label for="keterampilan" class="form-label">Keterampilan</label>
              <textarea class="form-control-text" id="keterampilan" name="keterampilan" rows="3" placeholder="Keterampilan" required><?php echo $data['keterampilan']; ?></textarea>
